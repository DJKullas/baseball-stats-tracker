...
import { socialLogin, signup } from "@/app/auth/actions"
...
function GoogleIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="48px" height="48px">
      ...
      <path
        fill="#1976D2"
        d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.089,5.571l6.19,5.238C42.021,35.596,44,30.138,44,24C44,22.659,43.862,21.35,43.611,20.083z"
      />
    </svg>
  )
}
      ...
      <Card className="w-full max-w-sm">
        ...
        <CardContent>
          ...
          <div className="grid grid-cols-2 gap-4">
            <form action={() => socialLogin("facebook")}>

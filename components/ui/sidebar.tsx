...
/**
 * Wrapper for the whole sidebar container.
 */
export function SidebarMain({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return <div className={cn("w-64 space-y-4", className)} {...props} />
}

/**
 * A `<nav>` element that groups sidebar links.
 */
export function SidebarNav({ className, ...props }: HTMLAttributes<HTMLNavElement>) {
  return <nav className={cn("flex flex-col gap-1", className)} {...props} />
}

/**
 * Individual sidebar link.
 * Use `active` to highlight the current route.
 */

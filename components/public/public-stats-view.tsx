...
export default function PublicStatsView({
  ...
  const filteredResults = useMemo(() => {
    ...
    if (selectedSeasonId !== "all") return results.filter((r) => r.season_id === selectedSeasonId)
  ...
  const getSelectedPeriodName = () => {
    ...
    if (selectedSeasonId !== "all") return seasons.find((s) => s.id === selectedSeasonId)?.name || "Selected Season"
    return "All Seasons"
  }
